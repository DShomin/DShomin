...
Currently, I'm building **LLM Applications** using **LangGraph**, focusing on:
- **RAG (Retrieval-Augmented Generation)** systems for knowledge-intensive tasks
- **Workflow Automation** pipelines powered by LLMs
- **Multi-Agent Systems** for complex problem-solving

I also have experience implementing deep learning model uncertainty and data drift monitoring for model lifecycle management in manufacturing environments.
...
<details>
<summary><b>Industry Experience (Click to expand)</b></summary>
